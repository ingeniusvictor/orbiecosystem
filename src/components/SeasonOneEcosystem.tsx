import { ArrowRight, Briefcase, Code2, FileText, Gamepad2, GraduationCap, Moon, Newspaper, Sparkles, Zap } from "lucide-react";
    ...
    <section id="ecosystem-season-one" className="relative overflow-hidden border-y border-white/5 bg-[#030712] py-20 sm:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-7 flex items-center justify-between gap-4 border-y border-white/10 py-4 text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">
          ...
          <span className="text-cyan-200">Dossier-ready / Video-ready / Servicio-ready</span>
        </div>
            ...
            return (
              ...
              >
                <div className="space-y-5">
                  ...
                  <div className="rounded-2xl border border-cyan-300/15 bg-cyan-300/[0.035] p-4 shadow-[0_18px_50px_rgba(8,145,178,0.08)]">
                    <div className="mb-3 flex items-center justify-between gap-3">
                      <span className="text-[10px] font-black uppercase tracking-[0.22em] text-cyan-100/80">Dossier interno</span>
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-xl border border-cyan-400/25 bg-cyan-400/10 px-4 py-3 text-[10px] font-black uppercase tracking-[0.24em] text-cyan-100 transition hover:border-cyan-300/60 hover:bg-cyan-400/15 hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-slate-950"
                    >
