...
function answerFromOrbiKnowledge(question: string): FotonAssistantResponse {
  ...
  if (normalizedIncludes(q, ["automatizacion web", "automatizacion de procesos", "automacion web", "automatizar un web", "automatizar una web", "automatizar pagina", "flujo", "workflow", "webhook", "proceso manual"])) {
    answer =
      "Sí. ORBI puede ayudarte a automatizar una web convirtiéndola en una herramienta operativa, no solo en una vitrina.\n\nPodemos trabajar automatizaciones como:\n\n1. Formularios inteligentes para captar solicitudes, clientes o incidencias.\n2. Respuestas automáticas por correo o mensajes internos.\n3. Registro de datos en Google Sheets, Notion, base de datos o panel interno.\n4. Dashboards para revisar estados, contactos, tareas o métricas.\n5. Webhooks y APIs para conectar la web con otras herramientas.\n6. Asistentes IA para orientar visitantes, responder preguntas frecuentes o filtrar oportunidades.\n7. Flujos de seguimiento para ventas, soporte, reservas, postulaciones o procesos técnicos.\n\nEl primer paso recomendado es definir qué proceso manual quieres reemplazar: captar datos, responder consultas, generar reportes, ordenar solicitudes o conectar sistemas. Desde ahí ORBI puede proponer una versión MVP rápida y escalable.";
